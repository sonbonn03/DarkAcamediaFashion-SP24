...
<html lang="en">
    ...
    <head>
        ...
        <link rel="preconnect" href="${pageContext.request.contextPath}/https://fonts.gstatic.com" crossorigin>
        <link href="${pageContext.request.contextPath}/https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;600&family=Raleway:wght@600;800&display=swap" rel="stylesheet"> 

        <!-- Icon Font Stylesheet -->
        <link rel="stylesheet" href="${pageContext.request.contextPath}/https://use.fontawesome.com/releases/v5.15.4/css/all.css"/>
        <link href="${pageContext.request.contextPath}/https://cdn.jsdelivr.net/npm/bootstrap-icons@1.4.1/font/bootstrap-icons.css" rel="stylesheet">
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            ...
            <ol class="breadcrumb justify-content-center mb-0">
                ...
                <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/#">Pages</a></li>
